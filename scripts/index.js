...
// This To Create a card on Home Page
...
const handleSubmit = (event) => {
  ...
  if (input.title === "" || input.type === "" || input.description === "") {
    return alert("Please Ensure  All The Fields Are Filled");
  }
...
// Opens The Modal When Clicking the Open Task On the UserInterface
const openTask = (e) => {
...
// Delete operation (Card To Be Deleted)
const deleteTask = (e) => {
  if (!e) e = window.event;
